...
public class MainServices {
     public  ArrayList<Diem> getAllMark(String masv) throws SQLException{
    ...
    public  ArrayList<Diem> getAllMarkByKy(String masv,int ky) throws SQLException{
       ConnectionSQL conn = new ConnectionSQL();
     ...
     public  Diem getMarkBySubject(String masv,int mamon) throws SQLException{
       ConnectionSQL conn = new ConnectionSQL();
     ...
     public  MonHoc getSubjectbyId(int mamon) throws SQLException{
       ConnectionSQL conn = new ConnectionSQL();
